  ...
  admin: {
    ...
    accounts: {
      ...
      oauth: {
        ...
        cookieAutoAuth: 'Get Setup Token with Cookie',
        cookieAutoAuthDesc:
          'Setup Token only: use a claude.ai sessionKey for inference access. This does not create an OAuth account.',

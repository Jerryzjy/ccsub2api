  ...
  admin: {
    ...
    accounts: {
      ...
      quotaControl: {
        ...
        tpmLimit: {
          label: 'TPM Limit',
          hint: 'Limit tokens per minute (input+output+cache) to protect upstream accounts',
          baseTpm: 'Base TPM',
          baseTpmPlaceholder: '200000',
          baseTpmHint: 'Max tokens per minute, 0 or empty means no limit. Closer to real upstream limits than RPM for large-context traffic',
          stickyBuffer: 'Sticky Buffer',
          stickyBufferPlaceholder: 'Default: 20% of base TPM',
          stickyBufferHint: 'Extra tokens allowed for sticky sessions after exceeding base TPM. Leave empty to use default (20% of base TPM, min 1)',
        },
        outboundHeaders: {
          label: 'Outbound Header Override',
          hint: 'Override or remove request headers per account before forwarding upstream',
          warning: '⚠️ This modifies headers sent upstream and may break client fingerprint mimicry, increasing ban risk. authorization and x-api-key are protected and cannot be overridden. Use only if you understand the consequences.',
          overridesLabel: 'Override / Add Headers',
          removesLabel: 'Remove Headers',
          namePlaceholder: 'Header name (e.g. X-Pool-Key)',
      ...
      oauth: {
        ...
        credentialsImport: 'Import credentials.json',
        credentialsImportDesc:
          'Import an existing Claude OAuth credentials.json and create an OAuth account. This does not convert a Cookie or sessionKey into OAuth.',
        credentialsFile: 'credentials.json file',
        credentialsFileHint:
          'Select a JSON file containing claudeAiOauth.accessToken and refreshToken',
        importingCredentials: 'Importing...',
        importCredentialsAndCreate: 'Import and create OAuth account',
        credentialsInvalid: 'credentials.json is invalid or missing OAuth credentials',
        cookieAutoAuth: 'Authorize with sessionKey',
        cookieAutoAuthDesc:
          'Use a claude.ai sessionKey for the selected OAuth or Setup Token access. This succeeds only when Anthropic accepts the session.',
        ...
        startAutoAuth: 'Authorize with sessionKey',

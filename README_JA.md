...
```bash
# 1. リポジトリをクローン
git clone https://github.com/Jerryzjy/ccsub2api.git
cd sub2api/deploy
...
<a href="https://star-history.com/#Jerryzjy/ccsub2api&Date">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=Jerryzjy/ccsub2api&type=Date&theme=dark" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=Jerryzjy/ccsub2api&type=Date" />
   <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=Jerryzjy/ccsub2api&type=Date" />
 </picture>
</a>

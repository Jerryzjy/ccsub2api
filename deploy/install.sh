...
# Sub2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/Jerryzjy/ccsub2api/master/deploy/install.sh | bash
#
...
# Configuration
GITHUB_REPO="Jerryzjy/ccsub2api"
...
Documentation=https://github.com/Jerryzjy/ccsub2api

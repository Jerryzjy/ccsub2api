...
curl -sSL https://raw.githubusercontent.com/Jerryzjy/ccsub2api/master/deploy/docker-deploy.sh -o docker-deploy.sh
...
1. Download the latest release from [GitHub Releases](https://github.com/Jerryzjy/ccsub2api/releases)
